...
RSpec.describe Post, type: :model do
  ...
  it 'is valid with valid attributes' do
    expect(Post.create(author: @author, Title: 'Hello', Text: 'This is my first post', Comments_Counter: 0,
                       Likes_Counter: 0)).to be_valid
  end

  it 'is not valid with title empty' do
    expect(Post.create(author: @author, Title: '', Text: 'This is my first post', Comments_Counter: 0,
                       Likes_Counter: 0)).to_not be_valid
  end

  it 'is not valid with title exceeding 250 characters ' do
    expect(Post.create(author: @author, Title: 'r' * 251, Text: 'This is my first post', Comments_Counter: 0,
                       Likes_Counter: 0)).to_not be_valid
  end
  ...
  it 'should return five (5) most recent comments' do
    post = Post.create(author: @author, Title: 'Hello', Text: 'This is my first post', Comments_Counter: 6,
                       Likes_Counter: 0)
